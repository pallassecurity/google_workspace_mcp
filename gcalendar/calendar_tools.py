...
async def create_event(
    ...
    start_time: str = Field(description='Start time (RFC3339, e.g., "2023-10-27T10:00:00-07:00" or "2023-10-27" for all-day).'),
    end_time: str = Field(description='End time (RFC3339, e.g., "2023-10-27T11:00:00-07:00" or "2023-10-28" for all-day).'),
    ...
    add_google_meet: bool = Field(default=False, description="Whether to add a Google Meet video conference to the event. Defaults to False."),
    reminders: Optional[Union[str, List[Dict[str, Any]]]] = Field(default=None, description="""JSON string or list of reminder objects. Each should have 'method' ("popup" or "email") and 'minutes' (0-40320). Max 5 reminders. Example: '[{"method": "popup", "minutes": 15}]' or [{"method": "popup", "minutes": 15}]"""),
    use_default_reminders: bool = Field(default=True, description="Whether to use calendar's default reminders. If False, uses custom reminders. Defaults to True."),
    transparency: Optional[str] = Field(default=None, description='Event transparency for busy/free status. "opaque" shows as Busy (default), "transparent" shows as Available/Free. Defaults to None (uses Google Calendar default).'),
) -> str:
    """
    Creates a new event.
    """
