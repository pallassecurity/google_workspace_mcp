...
async def create_presentation(
    ...
    title: str = Field(default="Untitled Presentation", description='The title for the new presentation. Defaults to "Untitled Presentation".')
) -> str:
    """
...
async def get_presentation(
    service,
    user_google_email: str = Field(description="The user's Google email address. Required."),
    presentation_id: str = Field(description="The ID of the presentation to retrieve.")
) -> str:
    """
...
async def batch_update_presentation(
    service,
    user_google_email: str = Field(description="The user's Google email address. Required."),
    presentation_id: str = Field(description="The ID of the presentation to update."),
    requests: List[Dict[str, Any]] = Field(description="List of update requests to apply.")
) -> str:
    """
...
async def get_page(
    ...
    page_object_id: str = Field(description="The object ID of the page/slide to retrieve.")
) -> str:
    """
...
async def get_page_thumbnail(
    ...
    user_google_email: str = Field(description="The user's Google email address. Required."),
    presentation_id: str = Field(description="The ID of the presentation."),
    page_object_id: str = Field(description="The object ID of the page/slide."),
    thumbnail_size: str = Field(default="MEDIUM", description='Size of thumbnail ("LARGE", "MEDIUM", "SMALL"). Defaults to "MEDIUM".')
) -> str:
    """
