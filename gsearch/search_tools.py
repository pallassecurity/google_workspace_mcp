...
async def search_custom(
    ...
    user_google_email: str = Field(
        description="User's Google email address. Required."
    ),
    q: str = Field(description="The search query. Required."),
    num: int = Field(
        default=10, description="Number of results to return (1-10). Defaults to 10."
    ),
    start: int = Field(
        default=1,
        description="The index of the first result to return (1-based). Defaults to 1.",
    ),
    safe: Literal["active", "moderate", "off"] = Field(
        default="off", description='Safe search level. Defaults to "off".'
    ),
    search_type: Optional[Literal["image"]] = Field(
        default=None, description='Search for images if set to "image".'
    ),
    site_search: Optional[str] = Field(
        default=None, description="Restrict search to a specific site/domain."
    ),
    site_search_filter: Optional[Literal["e", "i"]] = Field(
        default=None, description='Exclude ("e") or include ("i") site_search results.'
    ),
    ...
    file_type: Optional[str] = Field(
        default=None, description='Filter by file type (e.g., "pdf", "doc").'
    ),
    language: Optional[str] = Field(
        default=None, description='Language code for results (e.g., "lang_en").'
    ),
    country: Optional[str] = Field(
        default=None, description='Country code for results (e.g., "countryUS").'
    ),
) -> str:
    """
